...
public class CountryDAO extends BaseDAO {
    ...
    public void save(Country country) {
        ...
        try (Connection conn = super.getConnection()) {
            PreparedStatement stmt = conn.prepareStatement("INSERT INTO country (code, name, continent, region, surfacearea, population, localname, governmentform, code2, latitude, longitude, capital) VALUES (?,?,?::continenttype,?,?,?,?,?,?,?,?,?)");
